...
class Bricks_IE_CLI_Command {
	...
	public function import( $args, $assoc_args ) {
		...
		if ( ! $yes ) {
			WP_CLI::log( 'This will overwrite your current Bricks settings, Style Manager data, theme styles, global classes, variables, color palettes, components, queries, elements, Bricks template/page content, and Bricks meta on enabled post types.' );
