			...
			wp_localize_script(
				...
				array(
					...
					'i18n'    => array(
						...
						'templateImages' => __( 'Import or reconnect template images.', 'bricks-ie' ),
						'notSupported'   => __( 'General page media files are not included in the archive.', 'bricks-ie' ),
		...
		<div class="wrap">
			...
			<div class="bricks-ie-section bricks-ie-section--import">
				...
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data" id="bricks-ie-import-form">
					...
					<p class="description bricks-ie-not-supported"><?php esc_html_e( 'General page media files are not included in the archive. Template images can be reconnected or imported with the option below.', 'bricks-ie' ); ?></p>
					...
					<p><span class="bricks-ie-label-with-help"><label><input type="checkbox" name="import_images" id="bricks-ie-import-images" value="1"> <?php esc_html_e( 'Import or reconnect template images.', 'bricks-ie' ); ?></label> <span class="bricks-ie-help-anchor"><button type="button" class="bricks-ie-help" aria-expanded="false" aria-controls="bricks-ie-images-help" aria-describedby="bricks-ie-images-help" aria-label="<?php esc_attr_e( 'About template images', 'bricks-ie' ); ?>"><span class="dashicons dashicons-editor-help" aria-hidden="true"></span></button><span id="bricks-ie-images-help" class="bricks-ie-tooltip" role="tooltip" hidden><?php esc_html_e( 'Reuses matching WordPress attachments and lets Bricks import missing public template images. Enable this when replacing templates that contain logos or other images.', 'bricks-ie' ); ?></span></span></span></p>
